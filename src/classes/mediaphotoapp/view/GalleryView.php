...
class GalleryView extends MediaphotoView implements Renderer
{
    public function render(): string
    {
        ...
        $html .= "</figcaption><div><a href=$updateGallery><button>Mettre à jour galerie</button></a><a href=$deleteGallery><button>Supprimer la galerie</button></a><a href=$addTags><button>Ajouter Tag</button></a><a href=$deleteTags><button>Supprimer Tag</button></a><a href=$addPicture><button>Ajouter image</button></a><a href=$giveAcces><button>Donner l'accès aux utilisateurs</button></a><a href=$removeAcces><button> Supprimer l'accès aux utilisateurs</button></a></div></section><article>";
